import { SpeechConfig, OutputFormat, AudioConfig, SpeechRecognizer, CancellationReason, ResultReason, PropertyId } from 'microsoft-cognitiveservices-speech-sdk';
...
class AzureSpeechRecognizer {
    constructor(speechSubscriptionKey, serviceRegion, endPoint, audioConfig) {
        ...
        this.speechConfig = SpeechConfig.fromSubscription(this.speechSubscriptionKey, this.serviceRegion);
    ...
    tryReco(recoStart) {
        return new Promise((resolve, reject) => {
            ...
            this.recognizer.canceled = (s, e) => {
                reject(new Error(CancellationReason[e.reason]));
            };
    ...
    startRecognizing() {
        ...
        this.recognizer.canceled = (s, e) => {
            var _a;
            let err = new Error(CancellationReason[e.reason]);
            if (this.onError) {
