(function (global, factory) {
    ...
    class HttpProtocol extends SerdeContext {
        ...
        async loadEventStreamCapability() {
            const { EventStreamSerde } = await Promise.resolve().then(function () { return index; });
