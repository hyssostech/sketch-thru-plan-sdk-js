...
Rendering makes use of a combination of open source renderers, weaved together in a custom  [`jmsrenderer.js`](jmsrenderer.js).
...
by the two open source renderers. 
...
The bulk of the additional functionality provided by `jsmrenderer.js` is the SVG rendering of labels, which are not provided
in the baseline tactical graphics renderer  Mission Command renderer (mil-sym-js).


The `mil-sym-js` renderer offers a variety of configurations. The local  [mil-sym-js.js](mil-sym-js.js) file included here
